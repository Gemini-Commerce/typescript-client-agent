...
let typeMap: {[index: string]: any} = {
    "AgentAgentEntity": AgentAgentEntity,
    "AgentCreateAgentRequest": AgentCreateAgentRequest,
    "AgentListAgentsRequest": AgentListAgentsRequest,
    "AgentListResponse": AgentListResponse,
    "AgentUpdateAgentRequest": AgentUpdateAgentRequest,
    "AgentUpdatePayload": AgentUpdatePayload,
    "ListRequestFilters": ListRequestFilters,
    "ListRequestSort": ListRequestSort,
