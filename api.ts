...
export const AgentApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async agentCreateAgent(tenantId: string, body: AgentCreateAgentRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AgentAgentEntity>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['AgentApi.agentCreateAgent']?.[localVarOperationServerIndex]?.url;
        ...
        async agentGetAgent(tenantId: string, id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AgentAgentEntity>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AgentApi.agentGetAgent']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async agentListAgents(tenantId: string, pageSize: number, body: AgentListAgentsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AgentListResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AgentApi.agentListAgents']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async agentUpdateAgent(tenantId: string, id: string, body: AgentUpdateAgentRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AgentAgentEntity>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AgentApi.agentUpdateAgent']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const AgentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        agentCreateAgent(tenantId: string, body: AgentCreateAgentRequest, options?: RawAxiosRequestConfig): AxiosPromise<AgentAgentEntity> {
         ...
         * @throws {RequiredError}
         */
        agentGetAgent(tenantId: string, id: string, options?: RawAxiosRequestConfig): AxiosPromise<AgentAgentEntity> {
         ...
         * @throws {RequiredError}
         */
        agentListAgents(tenantId: string, pageSize: number, body: AgentListAgentsRequest, options?: RawAxiosRequestConfig): AxiosPromise<AgentListResponse> {
         ...
         * @throws {RequiredError}
         */
        agentUpdateAgent(tenantId: string, id: string, body: AgentUpdateAgentRequest, options?: RawAxiosRequestConfig): AxiosPromise<AgentAgentEntity> {
